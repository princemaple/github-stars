...
Install Visual Studio with the Desktop development with C++ workload, CMake 3.14 or newer, and vcpkg. Set `VCPKG_ROOT` to the vcpkg checkout, then configure and build from PowerShell:
...
To build cimbar.js (what cimbar.org uses), see WASM. Or use the latest release.
