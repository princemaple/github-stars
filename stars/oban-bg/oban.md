...
To run the Oban test suite you must have PostgreSQL 14+ and MySQL 8+ running. Follow these steps to create the database, create the database and run all migrations:
