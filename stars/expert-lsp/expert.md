...
You can then point your editor to the `start_expert` executable from the generated release (`apps/expert/_build/prod/rel/plain`). You can also run `start_expert --help` to see all available options.
