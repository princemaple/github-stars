...
Angular Material and the CDK follow the same support and release policy as the Angular framework. For details on supported versions and update practices, see the Angular support policy and schedule.
