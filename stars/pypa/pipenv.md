...
Shell completion is powered by argcomplete. Install the optional dependency first:
...
> **Note:** If you are upgrading from pipenv < 2026.5.0, the old `_PIPENV_COMPLETE` environment variable method no longer works. Replace it with the `register-python-argcomplete` commands above. See the Shell Completion docs for details.
