...
See docs/SYNTAX\_HIGHLIGHTING.md for complete guide.
...
-   **Autocomplete / mention popups** - GitHub-style `@mention` and `#issue` popups built entirely on the public API, no core changes.
