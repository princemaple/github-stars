...
-   In case of the classic musl-based distribution (`filc-0.680-linux-x86_64.tar.xz`), this sets up Fil-C to run in the current directory.
    
-   In case of the /opt/fil glibc-based distribution (`optfil-0.680-linux-x86_64.tar.xz`), this sets up Fil-C in `/opt/fil`.
