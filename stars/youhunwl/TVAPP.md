...
安卓6.0及以上，不支持纯血鸿蒙，需设置接口源，本仓库下方有分享。其他版本下载
...
同小苹果TV作者，在其基础上新增缓存下载功能，对各种源的资源能播即能缓存下载
...
Cinetry 是一款专为影音爱好者打造的本地客户端播放器，全平台覆盖
...
追剧、直播、无广、投屏、免费。 **iOS & Android & Win & Mac**
...
Kodi是一款专业的多媒体影音播放器，可播放本地存储、网络共享及流媒体内容。 kodi教程
...
全民K歌2026TV电视版-官方遗留版本修复-无广告免会员无限制版
...
webview同类型的直播应用软件，节目资源丰富，包括央视、卫视、地方台。新版已更名为**我的电视**
...
VsTV 让你在 智能电视、电视盒子、平板或手机 上收看直播频道
...
最新修复版可用了，切勿更新！如果弹出激活不去管他过几天就又可以用了。
...
野草助手APP一款可以方便用户快捷的在电视端安装应用的应用工具，口令、远程安装等多种途径可以快速辅助大家安装应用。小米电视海信电视专版
...
专为安卓智能电视打造的儿歌应用，种类非常丰富。**目前无法获取数据**
...
一款用于电视全面检测屏幕的软件，拥有清晰度测试、灰度测试、色彩测试、坏点测试等功能。
...
和野草助手一样是一款可以方便用户快捷的在电视端安装应用的应用工具，可以访问：https://zhushou.huan.tv 上传应用，也可以在微信小程序**欢视助手**上传分享。
