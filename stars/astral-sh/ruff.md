...
For the complete list of enabled rules, see _Default Rules_.
...
If you're just getting started with Ruff, **the default rule set is a great place to start**: it catches a wide variety of common errors (like unused imports) with zero configuration. See _Default Rules_ for the complete list.
