...
url: https://github.com/d2lang/d2
---
...
D2 bundles three layout engines. Select one with `--layout=dagre`, `--layout=elk`, or `--layout=tala`. You can also set `D2_LAYOUT` or `vars.d2-config.layout-engine` in D2 source. Run `d2 layout` to list the engines or `d2 layout <name>` for their configuration options.
...
-   **VSCode extension**: https://github.com/d2lang/d2-vscode
-   **Vim extension**: https://github.com/d2lang/d2-vim
-   **Obsidian plugin**: https://github.com/d2lang/d2-obsidian
...
-   **Comparison site**: https://github.com/d2lang/text-to-diagram-site
-   **Playground**: https://github.com/d2lang/d2-playground
-   **Language docs**: https://github.com/d2lang/d2-docs
-   **Hosted icons**: https://icons.d2lang.com
